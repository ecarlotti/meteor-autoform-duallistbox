...
Template.afSelectTransfer.rendered = function () {
  this.$('select').bootstrapDualListbox(template.data.atts.bootstrapDualListboxOptions || {});
};

Template.afSelectTransfer.destroyed = function () {
  try {
